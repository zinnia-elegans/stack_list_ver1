                                        ...
                                        <div class="media">
                                            <img src="{{ $tweet->user->profile_image_url_https }}" class="rounded-circle mr-4">
                                                <div class="media-body">
                                                    <a href="#"><h5 class="d-inline mr-3"><strong>{{ $tweet->user->name }}</strong></h5></a>
                                                    <h6 class="d-inline text-secondary">{{ date('Y/m/d', strtotime($tweet->created_at)) }}</h6>
                                                <div class="content-wrap animated">
                                                    <div class="content-txt"><p>{{ $tweet->text }}</p></div>
                                                    <div class="more-btn btn-black"><p class="open">もっと見る</p></div>
                                                </div>
                                        </div>
                                    </div>
                                    </div>
