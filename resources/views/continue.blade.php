...
@section('content')
    <body>
        <div class="card mx-auto" style="width: 37.5rem">
            <div class="card-body">
                <h3>現在の継続日数を確認する</h3>
                    <form id="test1" action="/" method="post" name="from">
                        <div class="form-group">
                            <input id="year" type="text" name="y" size="6" maxlength="4" placeholder="2020"/> 年 
                            ...
                            <input id="calcButton" class="btn-primary" type="submit" name="regist" value="計算" />
